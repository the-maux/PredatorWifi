...
class SubMain(QWidget):
    ...
    def showProbe(self):
        ...
        self.Fprobe.setGeometry(QRect(100, 100, 400, 800))
        self.Fprobe.show()
    ...
    def StartApFake(self):
        ...
        if selected_dhcp == 'iscdhcpserver':
            Thread_dhcp = ThRunDhcp(['sudo','dhcpd','-d','-f','-lf','Settings/dhcp/dhcpd.leases','-cf', '/etc/dhcp/dhcpd.conf',self.ConfigTwin['AP_iface']])
