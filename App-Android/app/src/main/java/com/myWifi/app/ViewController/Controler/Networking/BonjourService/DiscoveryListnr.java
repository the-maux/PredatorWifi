...
public class DiscoveryListnr implements NsdManager.DiscoveryListener {
    private String                      TAG = "DiscoveryListnr";
    private BonjourManager              BonjourManager;
    private String                      type;
    private DiscoveryListnr instance = this;

    public DiscoveryListnr(BonjourManager manager, String type) {
