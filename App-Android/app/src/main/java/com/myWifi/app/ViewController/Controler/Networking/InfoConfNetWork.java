...
public class InfoConfNetWork {
    private String              TAG = "InfoConfNetWork";
    private static Activity     Instance = null;
    private static InfoConfNetWork managerInstance = null;
    ...
    public InfoConfNetWork(Activity activity) {
        Instance = activity;
        initInfoNet();
    }
