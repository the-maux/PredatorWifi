package com.myWifi.app.ViewController.View.Adapter.Predator;
...
import com.myWifi.app.ViewController.Controler.Predator.MyWifiConfiguration;
...
public class                ClientProbeAdapter extends ArrayAdapter<ClientPredator> {
    ...
    public View             getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.lv_client_probe_predator, parent, false);
        }
