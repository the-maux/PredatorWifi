...
import com.myWifi.app.ViewController.Model.Predator.Record;
...
public class                    recordClientAdapter extends ArrayAdapter<Record> {
    ...
    public View                 getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.lv_client_probe_detail_record, parent, false);
        }
